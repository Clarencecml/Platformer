...
void GameStateMgrUpdate()
{
	...
	case GS_MENU:
		...
		break;
	case GS_PLATFORM:
		GameStateLoad	= GameStatePlatformLoad_1;
		GameStateInit	= GameStatePlatformInit_1;
		GameStateUpdate	= GameStatePlatformUpdate;
		GameStateDraw	= GameStatePlatformDraw_1;
		GameStateFree	= GameStatePlatformFree;
		GameStateUnload	= GameStatePlatformUnload;
		break;
	case GS_PLATFORM2:
		GameStateLoad = GameStatePlatformLoad_2;
		GameStateInit = GameStatePlatformInit_2;
		GameStateUpdate = GameStatePlatformUpdate;
		GameStateDraw = GameStatePlatformDraw_2;
		GameStateFree = GameStatePlatformFree;
		GameStateUnload = GameStatePlatformUnload;
		break;
	default:
